<footer class="main-footer">
                ...
                <strong>Copyright &copy; 2016 <a href="http://ramasatria.it.student.pens.ac.id/job_hunter"  target="_blank">Cari Kerja</a>.</strong> All rights reserved.
            </footer>
        </div><!-- ./wrapper -->
    ...
    <script>
      $(function () {
        ...
        var donut = new Morris.Donut({
          ...
          data: [
            {label: "Perusahaan", value: <?php foreach ($perusahaan as $co) echo $co?>} ,
            {label: "Pelamar", value: <?php foreach ($pelamar as $co) echo $co?>}

             ...
             <!--  <div class="col-xs-2"><tr><td><a href="<?php echo site_url('super_administrator/tambah_user'); ?>"class="btn btn-block btn-primary">Tambah</a></td></tr></div> -->
                ...
                <div class="box-body">
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <td><a class="btn btn-block btn-primary btnx-s" href="<?php $status='Disactivated'; echo site_url("backend/user_manajemen/update_status/$data->id/$status"); ?>"><i class="fa fa-fw fa-edit"></i> </a><a class="btn btn-block btn-danger" href="<?php echo site_url("backend/user_manajemen/delete/$data->id"); ?>" onClick="return doconfirm();">

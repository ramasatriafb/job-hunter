...
class Daftar_bookmark extends CI_Controller {
...
function __construct()
	...
	{
		$user = $this->set_var();
		$data['daftar_bookmark'] = $this->Lowongan_model->get_daftar_bookmark_all();
		
		$this->load->view('backend/daftar_bookmark',$data);
	}
	// public function delete($ID)
	// {
	// 	$this->Perusahaan_model->delete($ID);
		
	// 	redirect('backend/perusahaan');
	// }
